...
Lors de l'**endosymbiose II^aire^**, *une cellule eucaryote hétérotrophe va phagocyter une cellule eucaryote autotrophe sans entrainer la lyse de la membrane plasmique*. Le noyau et le cytoplasme dégénère, le chloroplaste est alors entouré de **4 membranes** (de l'intérieur vers l'extérieur du plaste) :   
...
La position du plaste peut être : 
  ...
  * *pariétal* : le plaste sur situe le long de la paroi de la cellule
  * *focal* : le plaste se situe au centre de la cellule
  * *ceinturant* : le plaste entoure le noyaux et d'autres organites
...
### Les organistes complémentaires de la photosynthèse
